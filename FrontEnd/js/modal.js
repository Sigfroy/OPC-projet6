...
// // Ajouter un écouteur d'événement pour la suppression du projet depuis la modale
// galleryModal.addEventListener('click', (event) => {
//     if (event.target.classList.contains('delete-icone')) {
//         const projectId = event.target.parentNode.getAttribute('data-id');
//         deleteProjectAndUpdateModal(projectId);
//     }
// });
...
// // Écouteur d'événement pour vérifier le formulaire lors de la saisie dans les champs
// photoTitleInput.addEventListener('input', validateForm);
// photoCategorySelect.addEventListener('input', validateForm);
// inputImage.addEventListener('change', validateForm); // Utilisez 'change' pour détecter les changements dans le champ de fichier
...
//             resetModalPhoto(); // Réinitialiser les champs de la deuxième modale
...
//     // Réinitialiser le titre de la photo
//     photoTitleInput.value = '';

//     // Réinitialiser la catégorie de la photo
...
//     // Réinitialiser le formulaire de la deuxième modal
//     resetModalPhoto();
// }
